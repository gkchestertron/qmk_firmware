...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_with_macro(
    KC_DEL, KC_ESC, KC_GRAVE, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_DEL,  KC_ESC, \
    ...
    KC_HOME, KC_INS, KC_CAPS, KC_LALT, KC_LGUI, KC_BSPC, MO(_FN1),          KC_SPC,KC_BSPC, KC_RGUI, KC_RALT, KC_LEFT, KC_COPY, KC_RCTL
  ),
  ...
  [_FN1] = LAYOUT(
    ...
    KC_TILD, _______, _______, _______, _______,          _______, _______, _______, _______, _______, KC_PSTE, _______
  )
};
